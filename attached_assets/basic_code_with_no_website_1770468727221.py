...
def print_menu():
    ...
    print("2. Multiple Stock Comparison (3M % performance + trend)")
...
def multiple_stock_comparison():
    ...
    print("\nTrend for selected stocks (based on SMA20 & SMA50):")
    for sym in syms:
        try:
            ...
            if latest_price > latest_sma20 and latest_sma20 > latest_sma50:
                ...
                trend = "Short-term bounce (price > SMA20, but SMA20 <= SMA50)."
            elif latest_price >= latest_sma50 and latest_sma20 > latest_sma50:
                trend = "Possible topping / consolidation."
            elif latest_price < latest_sma20 and latest_sma20 > latest_sma50:
                trend = "Pullback in an uptrend (watch for support)."
            else:
                trend = "Downtrend / weak trend (price below SMAs)."
