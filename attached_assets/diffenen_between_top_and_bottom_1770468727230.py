...
# ---------- classify list of stocks into bullish / bearish ----------
def classify_stock_list_bull_bear():
    print("\nCLASSIFY STOCKS INTO BULLISH / BEARISH (RSI+MACD)")
    ...
    for sym in syms:
        ...
        print(f"RSI14={latest_rsi:.1f}, MACD={latest_macd:.4f}, HistΔ={hist_slope:.4f}")
        print(scenario)
...
# ---------- scan all Nifty 50 and list bullish / bearish ----------
def list_bullish_stocks():
    ...
    for sym in nifty50_symbols:
        ...
        scenario = classify_rsi_macd_scenario(latest_rsi, latest_macd, hist_slope)
        if "Bullish" in scenario:
            bullish.append((sym, latest_rsi, latest_macd, hist_slope, scenario))
    ...
    for sym, r, m, h, scen in bullish:
        print(f"{sym}: RSI14={r:.1f}, MACD={m:.4f}, HistΔ={h:.4f} -> {scen}")
    print("=========================================\n")
...
def list_bearish_stocks():
    ...
    for sym in nifty50_symbols:
        ...
        if "Bearish" in scenario:
            bearish.append((sym, latest_rsi, latest_macd, hist_slope, scenario))
...
def print_menu():
    ...
    print("5. Classify Custom List into Bullish / Bearish (RSI+MACD)")
    print("0. Exit")
    print("-"*60)
