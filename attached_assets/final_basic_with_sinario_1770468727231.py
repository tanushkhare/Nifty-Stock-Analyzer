...
# ---------- RSI+MACD text classifier (your original) ----------
...
scenarios = [
    {'price':'↑','vol':'↑','oi':'↑','Direction':'Bullish','signal':'Strong Bullish (Long Build)','rsi_low':55,'rsi_high':70,
     'macd':'Above 0, Hist ↑','action':'STRONG BUY','win_low':80,'win_high':90,'risk':'LOW'},
    {'price':'↑','vol':'↑','oi':'↓','Direction':'Bullish','signal':'Short Covering (Weak Rally)','rsi_low':40,'rsi_high':55,
     'macd':'Above 0, Hist Flat','action':'Buy Caution','win_low':60,'win_high':70,'risk':'MEDIUM'},
    {'price':'↑','vol':'↓','oi':'↑','Direction':'Bullish','signal':'Quiet Accumulation','rsi_low':60,'rsi_high':75,
     'macd':'Above 0, Stable','action':'BUY Setup Valid','win_low':75,'win_high':85,'risk':'MED-HIGH'},
    {'price':'↑','vol':'↓','oi':'↓','Direction':'Bullish','signal':'Profit-Taking Reversal','rsi_low':45,'rsi_high':60,
     'macd':'Above 0, Hist ↓','action':'EXIT/SKIP','win_low':30,'win_high':40,'risk':'HIGH'},
    {'price':'↓','vol':'↑','oi':'↑','Direction':'Bearish','signal':'Strong Bearish (Short Build)','rsi_low':20,'rsi_high':40,
     'macd':'Below 0, Hist ↓','action':'STRONG SELL','win_low':70,'win_high':80,'risk':'LOW'},
    {'price':'↓','vol':'↑','oi':'↓','Direction':'Bearish','signal':'Liquidation (Panic)','rsi_low':20,'rsi_high':35,
     'macd':'Below 0, Hist ↑','action':'Exit Shorts','win_low':50,'win_high':60,'risk':'HIGH'},
    {'price':'↓','vol':'↓','oi':'↑','Direction':'Bearish','signal':'Bearish Caution','rsi_low':30,'rsi_high':50,
     'macd':'Below 0, Stable','action':'AVOID','win_low':30,'win_high':40,'risk':'MEDIUM'},
    {'price':'↓','vol':'↓','oi':'↓','Direction':'Bearish','signal':'Reversal Likely','rsi_low':20,'rsi_high':40,
     'macd':'Crossing 0','action':'WATCH','win_low':40,'win_high':50,'risk':'MEDIUM'}
]
...
# ---------- MULTIPLE STOCK COMPARISON (unchanged) ----------
